...
export function LayerCard({ layer, isFirst, isLast }: LayerCardProps) {
    ...
    const hyperparametersStore = useHyperparametersStore();
    const {
        updateLayer,
        removeLayer,
        moveLayerUp,
        moveLayerDown,
        setDefaultCustomFunction,
        globalCustomFunctions,
        addGlobalCustomFunction,
        updateGlobalCustomFunction,
        removeGlobalCustomFunction
    } = hyperparametersStore;
